...
% Your code here:
for dummy_character=1:n
    factors(dummy_character).var = dummy_character;
    factors(dummy_character).card = 26;
    factors(dummy_character).val = ComputeImageFactor(images(dummy_character).img, imageModel);
end
